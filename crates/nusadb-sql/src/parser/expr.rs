...
fn scalar_func_by_name(name: &str) -> Option<ast::ScalarFunc> {
    ...
    Some(match name {
        ...
        "jsonb_set_lax" => F::JsonbSetLax,
        "xml_is_well_formed" => F::XmlIsWellFormed,
        ...
        "jsonb_extract_path" | "json_extract_path" => F::JsonExtractPath,
        "jsonb_extract_path_text" | "json_extract_path_text" => F::JsonExtractPathText,
