...
#[test]
fn slt_p1_rename_column_guard() {
    run_slt("tests/slt/p1_ddl/rename_column_guard.slt");
}
...
#[test]
fn slt_p10_macaddr() {
    run_slt("tests/slt/p10_types/macaddr.slt");
}
...
#[test]
fn slt_p10_range() {
    run_slt("tests/slt/p10_types/range.slt");
}
